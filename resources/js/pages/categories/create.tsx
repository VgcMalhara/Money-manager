        ...
        <>
            ...
            <div className="max-w-md mx-auto min-h-screen bg-background sm:bg-muted/10 p-4 sm:p-8">
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <h1 className="text-lg font-extrabold uppercase tracking-tighter italic">Create Category</h1>
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className="bg-card rounded-[2.5rem] p-8 shadow-sm border border-border/40 space-y-8">
                        ...
                        {/* Income/Expense Toggle (Better UX) */}
                    ...
                    <div className="bg-card rounded-[2rem] p-6 shadow-sm border border-border/40 space-y-4">
                        <Label className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground ml-1">Theme Color</Label>
                    ...
                    {/* Icon Grid Section */}
                    <div className="bg-card rounded-[2rem] p-6 shadow-sm border border-border/40 space-y-4">
                        <Label className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground ml-1">Select Icon</Label>
...
Create.layout = {
    breadcrumbs: [{ title: 'Categories', href: '/categories' }, { title: 'New', href: '#' }],
};
